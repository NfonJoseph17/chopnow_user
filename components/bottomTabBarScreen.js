...
const BottomTabBarScreen = ({ navigation, route }) => {
  ...
  const checkPersonalsVisibility = async () => {
    const personalsVisible = await AsyncStorage.getItem('personalsVisible')||'true';
    if(personalsVisible==='true') {
      navigation.navigate("Personals");
    };
  };
